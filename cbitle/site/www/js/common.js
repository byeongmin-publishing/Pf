...
(function ($) {
    ...
    $(function () {
        ...
        //푸터 배너 시작
        var $FooterBannerBox = $('.footer_banner_box'),
            $FooterBannerList = $FooterBannerBox.find('.footer_banner_list');
        ...
        $FooterBannerList.slick({
            ...
            infinite : true,
            arrows : true,
            prevArrow : $FooterBannerBox.find('.footer_banner_control .slick-arrow.prev'),
            nextArrow : $FooterBannerBox.find('.footer_banner_control .slick-arrow.next'),
            autoArrow : $FooterBannerBox.find('.footer_banner_control .slick-arrow.auto'),
            pauseText : '정지',
            playText : '재생',
            isRunOnLowIE: true,
