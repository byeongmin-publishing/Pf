    ...
    $(function () {
        ...
        $('.rowgroup6 .map_tab_box .item_btn').on('click', function(){
            ...
            if(!IsActive){
                ...
                $('.map_active_img').attr('src', '../www/images/main/map_active'+ParentsIndex+'.png');
        ...
        $Mapping.on('mouseover focusin', function() {
            ...
            $('.map_hover_img').css({'backgroundImage': 'url(../www/images/main/map_over'+$thissrcIndex + '.png)'});
        });
        ...
        $Mapping.on('click', function(e) {
            ...
            $('.map_active_img').attr('src', '../www/images/main/map_active'+$thissrcIndex+'.png');
